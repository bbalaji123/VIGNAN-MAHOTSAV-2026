  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        {/* Note */}
        <div className="bangalore-content max-w-[1200px] mx-auto mt-0 text-center text-white/90 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed px-4 sm:px-8 py-4 sm:py-5 md:py-6" style={{ fontFamily: 'arial, sans-serif !important', marginTop: '20px', marginBottom: '20px' }}>
