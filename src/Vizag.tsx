    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          >
            <img src="https://res.cloudinary.com/dffldabvf/image/upload/v1768357528/VIZAG_pcabnp_dvl0xw.avif" alt="Vizag" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="eager" decoding="async" />
          </div>

          {/* Events Table */}
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="Vizag-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px] p-4 sm:p-6 md:p-8 lg:p-10" style={{ minHeight: '300px', width: '100%', maxWidth: '700px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            {/* Contacts */}
            <div className="Vizag-content mt-3 sm:mt-4 md:mt-6 text-white text-center pt-4 sm:pt-5 md:pt-6" style={{ fontFamily: 'Aladin, cursive !important', paddingTop: '20px' }}>
          ...
          <div className="Vizag-content flex flex-col items-center justify-center gap-3 sm:gap-4 mx-auto lg:flex-shrink-0" style={{ height: '400px' }}>
            <div className="text-xs sm:text-sm md:text-base font-semibold text-white uppercase tracking-widest" style={{marginBottom: '-50px'}}>
              HOSTING PARTNER
            </div>
            <div className="w-[220px] h-[220px] sm:w-[250px] sm:h-[250px] md:w-[280px] md:h-[280px] flex items-center justify-center">
              <img src="/images/VIZAG.png" alt="Hosting Partner" className="w-full h-full object-contain" />
            </div>
        ...
        {/* Note */}
        <div className="Vizag-content max-w-[1200px] mx-auto mt-0 text-center text-white/90 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed px-6 sm:px-12 md:px-16 py-4 sm:py-5 md:py-6" style={{ fontFamily: 'arial, sans-serif !important', marginTop: '20px', marginBottom: '20px' }}>
