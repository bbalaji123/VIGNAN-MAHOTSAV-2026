    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          >
            <img src="https://res.cloudinary.com/dctuev0mm/image/upload/f_auto,q_auto:good,w_1200/v1766929714/TIRUPATHI_y1iypg.avif" alt="Tirupathi" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" decoding="async" />
          </div>

          {/* Events Table */}
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="Tirupathi-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px] p-4 sm:p-6 md:p-8 lg:p-10" style={{ minHeight: '300px', width: '100%', maxWidth: '700px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',marginTop:'20px' }}>
            ...
            {/* Contacts */}
            <div className="Tirupathi-content mt-3 sm:mt-4 md:mt-6 text-white text-center pt-4 sm:pt-5 md:pt-6" style={{ fontFamily: 'Aladin, cursive !important', paddingTop: '20px' }}>
          ...
          <div className="Tirupathi-content flex flex-col items-center justify-center gap-3 sm:gap-4 mx-auto lg:flex-shrink-0" style={{ height: '400px' }}>
            ...
            <div className="w-[180px] h-[140px] sm:w-[190px] sm:h-[150px] md:w-[200px] md:h-[160px] flex items-center justify-center">
              <img src="/images/tirupati-logo.png" alt="Hosting Partner" className="w-full h-full object-cover" />
            </div>
