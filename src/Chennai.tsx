    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-8 sm:py-12 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          >
            <img src="https://res.cloudinary.com/dctuev0mm/image/upload/f_auto,q_auto:good,w_1200/v1766929725/CHENNAI_kq6tgd.avif" alt="Chennai" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" decoding="async" />
          </div>

          {/* Events Table */}
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="Chennai-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px] p-4 sm:p-6 md:p-8 lg:p-10" style={{ minHeight: '300px', width: '100%', maxWidth: '700px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white text-center uppercase tracking-wider" style={{ fontFamily: 'Aladin, cursive !important', marginTop: '40px', marginBottom: '40px' }}>
                ZONAL EVENTS (MEN)
              </h3>
          ...
          {/* Hosting Partner */}
          <div className="Chennai-content flex flex-col items-center justify-center gap-3 sm:gap-4 mx-auto lg:flex-shrink-0" style={{ height: '400px' }}>
            ...
            <div className="w-[140px] h-[140px] sm:w-[160px] sm:h-[160px] md:w-[180px] md:h-[180px] rounded-full bg-white/90 flex items-center justify-center p-3 sm:p-4 shadow-[0_5px_20px_rgba(0,0,0,0.3)]">
              <img src="/images/chennai1.avif" alt="Hosting Partner" className="w-full h-full object-contain" />
            </div>
        ...
        {/* Note */}
        <div className="Chennai-content max-w-[1200px] mx-auto mt-0 text-center text-white/90 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed px-6 sm:px-12 md:px-16 py-4 sm:py-5 md:py-6" style={{ fontFamily: 'arial, sans-serif !important', marginTop: '20px', marginBottom: '20px' }}>
