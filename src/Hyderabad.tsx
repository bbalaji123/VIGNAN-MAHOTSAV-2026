    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden" style={{
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-12 sm:py-12 md:py-8 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 sm:gap-12 max-w-[1400px] mx-auto">
          ...
          >
            <img src="https://res.cloudinary.com/dctuev0mm/image/upload/f_auto,q_auto:good,w_1200/v1766929711/HYDERABAD_yg7ryn.avif" alt="Hyderabad" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" decoding="async" />
          </div>

          {/* Events Table */}
          <div className="flex-1 w-full max-w-[600px] mx-auto lg:mx-0">
            <div className="Hyderabad-content bg-[rgba(82,37,102,0.3)] border-2 border-dashed border-white/50 rounded-lg backdrop-blur-[10px] p-4 sm:p-6 md:p-8 lg:p-10" style={{ minHeight: '300px', width: '100%', maxWidth: '750px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', marginTop: '30px' }}>
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white text-center uppercase tracking-wider" style={{ fontFamily: 'Aladin, cursive !important', marginTop: '40px', marginBottom: '30px', marginLeft: '40px', marginRight: '40px' }}>
                ZONAL EVENTS (MEN)
              </h3>
              <div className="grid grid-cols-[auto_1fr] gap-4 md:flex md:flex-row md:gap-8 lg:gap-12 text-white" style={{ fontFamily: 'Aladin, cursive !important' }}>
                ...
                <div className="flex flex-col gap-2 sm:gap-3 min-w-[100px] sm:min-w-[120px] md:min-w-[150px]">
                  ...
                  <div className="flex flex-col py-2 sm:py-3">
                    <div className="font-bold text-sm sm:text-base md:text-lg lg:text-xl mb-1" style={{ fontFamily: 'Aladin, cursive !important', marginLeft: '10px' }}>Football</div>
            ...
            {/* Contacts */}
            <div className="Hyderabad-content mt-3 sm:mt-4 md:mt-6 text-white text-center pt-4 sm:pt-5 md:pt-6" style={{ fontFamily: 'Aladin, cursive !important', paddingTop: '20px' }}>
              <div className="text-sm sm:text-base md:text-lg font-semibold">
                <div>Mr. K. Pavan Kumar - +91 78938 83123</div>
              </div>
            </div>
          </div>

          {/* Hosting Partner */}
          <div className="Hyderabad-content flex flex-col items-center justify-center gap-3 sm:gap-4 mx-auto lg:flex-shrink-0" style={{ height: '400px' }}>
